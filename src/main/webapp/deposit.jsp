...
<%
    ...
    // Get translated modal texts
    String depositSubmittedTitle = LanguageHelper.getMessage("deposit_submit", lang);
    String depositSubmittedMessage = LanguageHelper.getMessage("deposit_submit1", lang);
    String okButton = LanguageHelper.getMessage("ok", lang);
%>

<jsp:useBean id="user" class="com.bank.model.User" scope="session" />
<%
...
<script defer data-site="YOUR_DOMAIN_HERE"
	...
	input.form-control.transparent-input #cardNumber{
			...
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb" style="padding-top:0px;">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page"><%=LanguageHelper.getMessage("deposit", lang)%></li>
                    </ol>
                    ...
                    <div class="card my-4 bg-glass3">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-purple shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-center text-capitalize ps-3"><%=LanguageHelper.getMessage("deposit_funds", lang)%></h6>
                            </div>
                        </div>
                        <div class="card-body px-4 pb-2">
					        ...
					        <% } %>
                             ...
                             <form action="DepositServlet" method="post">
                            	<div class="mb-3">
                                    <label for="cardNumber" class="form-label text-white"><%=LanguageHelper.getMessage("acc_num", lang)%></label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <input type="number" class="form-control transparent-input" id="amount"
                                            placeholder="<%=LanguageHelper.getMessage("enter_amt", lang)%>" name="amount" step="0.01" required>
                                ...
                                <div class="mb-3">
                                    <label for="dateTime" class="form-label text-white"><%=LanguageHelper.getMessage("password", lang)%></label>
                                    <div class="input-group input-group-outline">
                                        <input type="password" class="form-control transparent-input" id="passowrd"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="successModalLabel"><%= depositSubmittedTitle %></h5>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal"><%= okButton %></button>
      </div>
    </div>
  </div>
</div>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
      ...
      function handleFreezeStatus(status) {
          ...
          if (status === "frozen") {	                
              if (!allowedLinks.includes(currentPage)) {
                  console.log("User is on a restricted page. Redirecting to homepage.jsp...");
