...
ResultSet rs = null;
String profilePic = "img/No_Img.jpg";
try {
    con = DatabaseConnection.getConnection();
    String query = "SELECT profile_picture FROM admin WHERE username=?";
          ...
          <a class="nav-link active" href="#manageUserDropdown2" data-bs-toggle="collapse" aria-expanded="false">
            ...
            <span class="nav-link-text ms-1">Manage Admin</span>
          		...
          		<ul id="manageUserDropdown2" class="collapse" style="list-style: none;">
                    <li class="nav-item">
                    	<a class="nav-link " id="hover-text" href="add_admin.jsp">
                        ...
                        <div class="card-header pb-0 p-3 bg-transparent">
                            <div class="row">
                                <div class="col-md-8 d-flex align-items-center">
                                    <h5 class="mb-0 text-white">Add Admin</h5>
                                </div>
                            </div>
                        </div>
...
<form action="AddAdminServlet" method="post">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control transparent-input" name="username" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label class="form-control-label text-white">Email address</label>
                <input type="email" class="form-control transparent-input" name="email" required>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="phone"
					...
					placeholder="+959" maxlength="15" pattern="(\+959|959)[0-9]{8,11}"
    ...
    <div class="d-flex justify-content-end mt-4 custom-gap">
        <a href="add_admin.jsp" class="btn m-0 text-white cancel-btn">Cancel</a>
        <button type="submit" class="btn text-white m-0 confirm-btn">Add</button>
    </div>
</form>
