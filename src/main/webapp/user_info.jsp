...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="collapse navbar-collapse  w-auto vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active " href="user_profile.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>customer-support</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Manage Admin</span>
          		...
          		<ul id="manageUserDropdown2" class="collapse" style="list-style: none;">
                    <li class="nav-item">
                        ...
                        <span class="nav-link-text" style="padding-left: 35px; margin: 0;">Add Admin</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    	<a class="nav-link" id="hover-link" href="view_admin.jsp">
                        <span class="nav-link-text" style="padding-left: 35px; margin: 0;">View Admin</span>
                        </a>
                    </li>
               	</ul>
        </li>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">User Information</h6>
          </nav>
