...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="collapse navbar-collapse  w-auto vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#manageUserDropdown2" data-bs-toggle="collapse" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="10px" height="10px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                          <title>settings</title>
                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Manage Admin</span>
          		...
          		<ul id="manageUserDropdown2" class="collapse" style="list-style: none;">
                    ...
                    <li class="nav-item">
                    	<a class="nav-link " id="hover-text" href="view_admin.jsp" >
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">View Admin</h6>
          </nav>
        ...
        <button id="searchBtn"
            ...
            <%
                ...
                try {
                    ...
                    String query = "SELECT a_id, username, email, phone, profile_picture FROM admin ORDER BY a_id " + sortOrder;
            ...
            <tr style="text-align:center; vertical-align: middle;">
               ...
               <td>
                    <% if (profilePic != null && !profilePic.isEmpty()) { %>
                        <img src="<%= profilePic %>" alt="Profile Picture" style="width:50px; height:50px; border-radius:50%;">
                    <% } else { %>
                        No Img
                    <% } %>
                </td></tr>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.0/xlsx.full.min.js"></script>
    ...
    document.getElementById('exportBtn').addEventListener('click', function() {
        ...
        if (exportType === 'pdf') {
            ...
            doc.text("Admin Information Table Export", 14, 10);
            ...
            doc.save('admin_information.pdf');
            ...
            link.download = "admin_information.doc";
            link.click();
            ...
            XLSX.writeFile(wb, 'admin_information.xlsx');
        }
    });
